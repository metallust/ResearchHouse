...
router.post(
	...
	[body("name", "Name can't be less that 3 character").isLength({ min: 3 }), body("email", "Give a valid Emal ..").isEmail(), body("password", "Password should be greater than 5 characters").isLength({ min: 5 })],
