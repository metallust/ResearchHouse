	...
	return (
		<div style={{ backgroundColor: "#e1f8ff", borderRadius: "5px", padding: "5px 10px 5px 10px", boxShadow: "0px 3px 4px 0px rgba(0,0,0,0.4)" }}>
			<svg width='15' height='19' viewBox='0 0 15 19' fill='none' xmlns='http://www.w3.org/2000/svg'>
				...
				/>
				<path d='M11 1V3.83333C11 3.96594 11.0527 4.09312 11.1464 4.18689C11.2402 4.28065 11.3674 4.33333 11.5 4.33333H14.3333' stroke='#004257' stroke-linecap='round' stroke-linejoin='round' />
			</svg>
		</div>
	);
}
