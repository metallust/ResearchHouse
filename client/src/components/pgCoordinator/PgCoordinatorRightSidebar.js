...
const PgCoordinatorRightSidebar = () => {
	const branch = "Computer Science";
	const batch = "2022-2023";
	const schedule = "Presentation";
	const scheduledate = "05/12/2012";

	const departments = ["Computer Science", "Information Technology", "Mechanical Engg", "Civil Engineering", "Artificial Intelligence", "Data Science"];
				...
				>
					{departments.map((name, index) => (
						<div
							...
							style={{
								width: "90%",
								color: activeDepartment === index ? "#E1F8FF" : "#004257",
								backgroundColor: activeDepartment === index ? "#004257" : "transparent",
				...
				>
					{batches.map((name, index) => (
						<div
							...
							style={{
								width: "90%",
								color: activeBatch === index ? "#E1F8FF" : "#004257",
								backgroundColor: activeBatch === index ? "#004257" : "transparent",
								border: "1px solid #004257",
								cursor: "pointer",
								transition: "background-color 0.3s, color 0.3s",
							}}
...
export default PgCoordinatorRightSidebar;
