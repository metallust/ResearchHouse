...
const AddStdManually = () => {
    ...
    var [tempStudent, setTempStudent] = useState([[1,2,3,4],[1,2,3,4]]);
    ...
    const handleAddStudent = (e) => {
        ...
        let temp = tempStudent
        let temp2 = temp.push([prn.value, studentemail.value, AddStudentBranch.value, AddStudentBatch.value])
        setTempStudent(temp2);
        ...
        <div>
            <form className="" onSubmit={handleAddStudent} method='post'>
                <div className="mb-3 d-flex">
                    <label htmlFor="prn" className="form-label me-2" style={{ width: "20%" }}>
                        PRN Number
                    </label>
                    <input id="prn" className="form-control" required name="prn" />
                </div>
                <div className="mb-3 d-flex">
                    <label htmlFor="studentemail" className="form-label me-2" style={{ width: "20%" }}>
                        Email:
                    </label>
